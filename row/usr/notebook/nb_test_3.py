...
import row.usr.notebook.common
...
def run (gis, org_id):
    ...
    try:
        ...
        item = row.usr.notebook.common.get_org_item (gis, f'{c.ITEM_TAG_ROOT}ORG_CENTERLINES', org_id)
        test_lyr = row.notebook.common.get_org_layer (gis, item, 0)
